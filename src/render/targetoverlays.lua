...
function targetoverlays.drawBrackets(drawX, drawY, width, height)
    ...
    love.graphics.setColor(TARGET_BRACKET_COLOR[1], TARGET_BRACKET_COLOR[2], TARGET_BRACKET_COLOR[3], pulseAlpha)
